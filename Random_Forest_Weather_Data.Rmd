...
Based on the variable importance plot we see that Dew Point (in $^oF$) is the most important variable in telling us about what the temperature will be. The next two important variables are the Humidity Perctentage and Solar ($W/m^2$). 
